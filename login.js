async function login() {
    ...
    fetch('https://shorturl-back.herokuapp.com/login', {
            method: "POST",
            ...
            if (res.status == 200) {
                ...
                window.location.href = "https://shorturl-back.herokuapp.com/urlshortener.html"
...
async function register() {
    ...
    fetch('https://shorturl-back.herokuapp.com/signup', {
            method: "POST",
            body: JSON.stringify(data),
            headers: {
                'content-Type': "application/json"
